...
const validateAdmin_1 = require("../../utils/validateAdmin");
...
const getDataById = (userId, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, validateAdmin_1.validateAdmin)(user, userInfo);
    return userInfo;
});
const updateData = (userId, user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, validateAdmin_1.validateAdmin)(user, isUserExist);
    const updateData = {
...
const deleteData = (userId, user) => __awaiter(void 0, void 0, void 0, function* () {
    const isUserExist = yield prisma_1.default.user.findUnique({
        where: {
            id: userId,
        },
...
const updateUserRole = (userId, user, role) => __awaiter(void 0, void 0, void 0, function* () {
    const isUserExist = yield prisma_1.default.user.findUnique({
        where: {
            id: userId,
        },
